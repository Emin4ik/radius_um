                    ...
                    <tr tabindex="0" class="h-16 border border-gray-100 rounded focus:outline-none">
                        ...
                        <td class="">
                            <div class="flex items-center pl-5">
                                ...
                                <p class="mr-2 text-base leading-none text-gray-700">{{$item->name}}</p>
                                ...
                                @foreach ($offers as $offer)
                                    @if ($item->id == $offer->store_id)
                                        <div class="relative inline-block rounded-full">
                                            ...
                                            <span class="absolute bottom-0 left-1/2 transform -translate-x-1/2 bg-black text-white px-2 py-1 text-xs opacity-0 transition-opacity duration-300 pointer-events-none hover:opacity-100">
                                                {{$offer->name}}
                                            </span>
                                        </div>
                                    @endif
